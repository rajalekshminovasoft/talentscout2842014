<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CopyRatingQuesToAnotherVariable.ascx.cs" Inherits="CopyRatingQuesToAnotherVariable" %>
<div align="left">
                    ...
                    <table style="width:100%;">
                        <tr style="font-weight: bold">
                            ...
                            <td width="320">
                                ...
                                <br />
                                Rating Type Questions Under it</td>
                            <td>
                                ...
                                <div>
                                    <asp:GridView ID="gvwQuestionBank" runat="server" AllowPaging="True" 
                                        ...
                                        SortExpression="Answer" />
                                            <asp:BoundField DataField="ScoringStyle" HeaderText="Scoring Style" />
                                        </Columns>
