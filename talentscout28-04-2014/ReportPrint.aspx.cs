...
public partial class ReportPrint : System.Web.UI.Page
{
   ...
   // string scoretype; int userid = 0;
            ...
            {                
                for (int j = 0; j < parts; j++)
                {
                    ...
                    if (j < GridView1.Rows.Count)
                    {
                        ...
                        tblCell = new TableCell();
                        tblCell.Style.Value = "text-align: right";//; font-weight: bold";
                        label = new Label(); label.Style.Value = "font-family: Arial; font-size: 10pt";//bip 17062010
                        label.Width = 50;
    ...
    private void DrawBarGraph()
    {
        ...
        //tblDisplay.Width = 630;
        tblDisplay.Style.Value = "width:98%";
        ...
        for (int j = 0; j < GridView1.Rows.Count; j++)
        {
            ...
            if (GridView1.Rows[j].Cells[1].Text != "&nbsp;")
            {
                ...
                tblRow = new TableRow();
                tblCell = new TableCell();
                tblCell.ColumnSpan = 2; tblCell.Style.Value = "padding:25px;";
                label = new Label();
                label.Font.Size = 15;
                label.Font.Bold = true;
               ...
               // tblCell.Controls.Add(label);
                ...
                //label.Width = 30;
                tblCell.Controls.Add(label);
                tblCell.Style.Value = "text-align: center; vertical-align: middle;padding:10px;";
                tblRow.Cells.Add(tblCell);
                tblDisplay.Rows.Add(tblRow);
                ...
                tblCell = new TableCell();
                tblCell.ColumnSpan = 2;
                label = new Label(); label.Width = 780;
                label.Font.Size = 12;
                //label.Font.Bold = true;
                label.Text = remarks;
                //label.Width = 30;
                ...
                //htc.InnerHtml = remarks;
                //tblCell.Controls.Add(htc);
                /////
                tblCell.Style.Value = "text-align: left; vertical-align: middle;";
                tblCell.Controls.Add(label);
