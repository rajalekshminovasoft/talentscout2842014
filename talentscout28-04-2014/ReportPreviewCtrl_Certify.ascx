<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportPreviewCtrl_Certify.ascx.cs" Inherits="ReportPreviewCtrl_Certify" %>
            ...
            <tr>
                <td>
                    <table width="100%">
                        ...
                        <tr>
                            <td id="Td3" runat="server" colspan="4" 
                        ...
                        <tr>
                            <td id="Td4" runat="server" colspan="4" 
                        ...
                        <tr>
                            <td id="Td5" runat="server" colspan="4" 
                        ...
                        <tr>
                            <td id="Td6" runat="server" colspan="4" style="padding-top: 15px">
                                <img alt="" src="images/ReportSubBorder.jpg" 
                                    style="width: 100%; height: 10px;" /></td>
                        </tr>
                        <tr>
                            <td id="Td7" runat="server" colspan="4" style="padding-top: 5px">
                        ...
                        <tr>
                            <td id="Td8" runat="server" colspan="4">
                        ...
                        <tr>
                            <td ID="Td9" runat="server" colspan="4" 
                            ...
                            <td runat="server" colspan="4" 
                                ...
                                <div>
                                    <div align="left">
                                        <table>
                                            <tr>
                                                <td ID="tcellBarGraph" runat="server" 
                                                    style="text-align: left; vertical-align: middle">
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <tr>
                            <td id="Td10" runat="server" colspan="4" 
                        ...
                        <tr>
                            <td id="Td12" colspan="4" runat="server">
                                <div align="center">
