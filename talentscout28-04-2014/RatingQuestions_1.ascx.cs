...
public partial class RatingQuestions : System.Web.UI.UserControl
{
        ...
        if (dsQuestioncount != null)
            if (dsQuestioncount.Tables.Count > 0)
                if (dsQuestioncount.Tables[0].Rows.Count > 0)
                {
                    ...
                    // }
                    querystring = "SELECT  QuestionID,Question,Answer,Option1,Option2,Option3,Option4,Option5,Option6,Option7,Option8,Option9,Option10,ScoringStyle  FROM TestBaseQuestionList_Temp where userid=" + userid + " ORDER BY RAND((1000*QuestionID)*DATEPART(millisecond, GETDATE())) ";
                    dsQuesCount = new DataSet();
                    dsQuesCount = clsclass.GetValuesFromDB(querystring);
                    if (dsQuesCount != null)
                        if (dsQuesCount.Tables[0].Rows.Count > 0)
                    ...
                    switch (j)
                    {
                        ...
                        case 4:
                            ...
                            if (ds.Tables[0].Rows[i]["Option9"].ToString() != "")
                            {
                                ...
                                rbQues5Answer9.Visible = true; lblJ5.Visible = true;
                        ...
                        case 5:
                            ...
                            if (ds.Tables[0].Rows[i]["Option1"].ToString() != "")
                            {
                                ...
                                rbQues6Answer1.Visible = true; lblA6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option2"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 2)
                                    lblB6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer2.Visible = true; lblB6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option3"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 3)
                                    lblC6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer3.Visible = true; lblC6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option4"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 4)
                                    lblD6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer4.Visible = true; lblD6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option5"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 5)
                                    lblE6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer5.Visible = true; lblE6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option6"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 6)
                                    lblF6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer6.Visible = true; lblF6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option7"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 7)
                                    lblG6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer7.Visible = true; lblG6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option8"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 8)
                                    lblH6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer8.Visible = true; lblH6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option9"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 9)
                                    lblI6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer9.Visible = true; lblI6.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option10"].ToString() != "")
                            {
                                lblTotalOptions6.Text = optindex.ToString();
                                if (optindex != 10)
                                    lblJ6.Text = GetAnswerOptionOrder(optindex);
                                rbQues6Answer10.Visible = true; lblJ6.Visible = true;
                        ...
                        case 6:
                           ...
                           // lblQues7.Text = ds.Tables[0].Rows[i]["Question"].ToString();
                            ...
                            if (ds.Tables[0].Rows[i]["Option1"].ToString() != "")
                            {
                                ...
                                rbQues7Answer1.Visible = true; lblA7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option2"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 2)
                                    lblB7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer2.Visible = true; lblB7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option3"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 3)
                                    lblC7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer3.Visible = true; lblC7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option4"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 4)
                                    lblD7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer4.Visible = true; lblD7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option5"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 5)
                                    lblE7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer5.Visible = true; lblE7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option6"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 6)
                                    lblF7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer6.Visible = true; lblF7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option7"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 7)
                                    lblG7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer7.Visible = true; lblG7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option8"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 8)
                                    lblH7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer8.Visible = true; lblH7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option9"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 9)
                                    lblI7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer9.Visible = true; lblI7.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option10"].ToString() != "")
                            {
                                lblTotalOptions7.Text = optindex.ToString();
                                if (optindex != 10)
                                    lblJ7.Text = GetAnswerOptionOrder(optindex);
                                rbQues7Answer10.Visible = true; lblJ7.Visible = true;
                        ...
                        case 7:
                            ...
                            if (ds.Tables[0].Rows[i]["Option1"].ToString() != "")
                            {
                                ...
                                rbQues8Answer1.Visible = true; lblA8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option2"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 2)
                                    lblB8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer2.Visible = true; lblB8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option3"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 3)
                                    lblC8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer3.Visible = true; lblC8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option4"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 4)
                                    lblD8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer4.Visible = true; lblD8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option5"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 5)
                                    lblE8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer5.Visible = true; lblE8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option6"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 6)
                                    lblF8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer6.Visible = true; lblF8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option7"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 7)
                                    lblG8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer7.Visible = true; lblG8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option8"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 8)
                                    lblH8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer8.Visible = true; lblH8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option9"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 9)
                                    lblI8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer9.Visible = true; lblI8.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option10"].ToString() != "")
                            {
                                lblTotalOptions8.Text = optindex.ToString();
                                if (optindex != 10)
                                    lblJ8.Text = GetAnswerOptionOrder(optindex);
                                rbQues8Answer10.Visible = true; lblJ8.Visible = true;
                        ...
                        case 8:
                            ...
                            if (ds.Tables[0].Rows[i]["Option1"].ToString() != "")
                            {
                                ...
                                rbQues9Answer1.Visible = true; lblA9.Visible = true;
                            ...
                            //radioQues9.Items.Add(ds.Tables[0].Rows[i]["Option1"].ToString());
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 2)
                                    lblB9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer2.Visible = true; lblB9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option3"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 3)
                                    lblC9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer3.Visible = true; lblC9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option4"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 4)
                                    lblD9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer4.Visible = true; lblD9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option5"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 5)
                                    lblE9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer5.Visible = true; lblE9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option6"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 6)
                                    lblF9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer6.Visible = true; lblF9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option7"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 7)
                                    lblG9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer7.Visible = true; lblG9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option8"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 8)
                                    lblH9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer8.Visible = true; lblH9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option9"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 9)
                                    lblI9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer9.Visible = true; lblI9.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option10"].ToString() != "")
                            {
                                lblTotalOptions9.Text = optindex.ToString();
                                if (optindex != 10)
                                    lblJ9.Text = GetAnswerOptionOrder(optindex);
                                rbQues9Answer10.Visible = true; lblJ9.Visible = true;
                        ...
                        case 9:
                            ...
                            if (ds.Tables[0].Rows[i]["Option1"].ToString() != "")
                            {
                                ...
                                rbQues10Answer1.Visible = true; lblA10.Visible = true; 
                            ...
                            if (ds.Tables[0].Rows[i]["Option2"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 2)
                                    lblB10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer2.Visible = true; lblB10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option3"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 3)
                                    lblC10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer3.Visible = true; lblC10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option4"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 4)
                                    lblD10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer4.Visible = true; lblD10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option5"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 5)
                                    lblE10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer5.Visible = true; lblE10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option6"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 6)
                                    lblF10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer6.Visible = true; lblF10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option7"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 7)
                                    lblG10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer7.Visible = true; lblG10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option8"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 8)
                                    lblH10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer8.Visible = true; lblH10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option9"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 9)
                                    lblI10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer9.Visible = true; lblI10.Visible = true;
                            ...
                            if (ds.Tables[0].Rows[i]["Option10"].ToString() != "")
                            {
                                lblTotalOptions10.Text = optindex.ToString();
                                if (optindex != 10)
                                    lblJ10.Text = GetAnswerOptionOrder(optindex);
                                rbQues10Answer10.Visible = true; lblJ10.Visible = true;
    ...
    private int GetRatingtypeAnswer(int index)
    {
        ...
        if (index == 1)
        {
            if (rbQues1Answer1.Text.Trim() != "") { optioncount++; if (rbQues1Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues2Answer1.Text.Trim() != "") { optioncount++; if (rbQues2Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues3Answer1.Text.Trim() != "") { optioncount++; if (rbQues3Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues4Answer1.Text.Trim() != "") { optioncount++; if (rbQues4Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues5Answer1.Text.Trim() != "") { optioncount++; if (rbQues5Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues6Answer1.Text.Trim() != "") { optioncount++; if (rbQues6Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues7Answer1.Text.Trim() != "") { optioncount++; if (rbQues7Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues8Answer1.Text.Trim() != "") { optioncount++; if (rbQues8Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues9Answer1.Text.Trim() != "") { optioncount++; if (rbQues9Answer1.Checked == true) answer = optioncount; }
        ...
        {
            if (rbQues10Answer1.Text.Trim() != "") { optioncount++; if (rbQues10Answer1.Checked == true) answer = optioncount; }
    ...
    private void SaveAnswer()
    {
        ...
        {           
            ...
            dataclass.Procedure_QuesAnswers(qusid1, usercode, tcellQues1.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        answer = 0;// "";
        ...
        {            
            ...
            dataclass.Procedure_QuesAnswers(qusid2, usercode, tcellQues2.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        ...
        {            
            ...
            dataclass.Procedure_QuesAnswers(qusid3, usercode, tcellQues3.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID4.Text.Trim() != "")
        {
            ...
            dataclass.Procedure_QuesAnswers(qusid4, usercode, tcellQues4.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID5.Text.Trim() != "")
        {
            ...
            dataclass.Procedure_QuesAnswers(qusid5, usercode, tcellQues5.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        ...
        if (lblQuesID6.Text.Trim() != "")
        {
            ...
            dataclass.Procedure_QuesAnswers(qusid6, usercode, tcellQues6.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        ...
        {           
            ...
            dataclass.Procedure_QuesAnswers(qusid7, usercode, tcellQues7.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        answer = 0;// "";
        ...
        {           
            ...
            dataclass.Procedure_QuesAnswers(qusid8, usercode, tcellQues8.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        ...
        {           
            ...
            dataclass.Procedure_QuesAnswers(qusid9, usercode, tcellQues9.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
        ...
        {           
            ...
            dataclass.Procedure_QuesAnswers(qusid10, usercode, tcellQues10.InnerHtml, answer.ToString(), userid, testId, testsectionid, quescategory);
        }
    }
