<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RptPrntGrp.aspx.cs" Inherits="RptPrntGrp" %>
                    ...
                    <tr>
                        <td>
                            <table style="width: 100%" >
                                ...
                                <tr>
                                    <td id="Td7" runat="server" colspan="4">
                                    ...
                                    <td colspan="4" style="padding: 10px">
                                        <div align="left">
                                            <table>
                                                ...
                                                <tr>
                                                    <td ID="tcellExplanations" runat="server" 
                                                        style="text-align: left; vertical-align: middle">
                                                        &nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td ID="tcellColorGrade" runat="server" 
                                                        style="text-align: left; vertical-align: middle">
                                                        &nbsp;</td>
                                                </tr>
                                            </table>
